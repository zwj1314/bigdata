...
<BODY>
	<FORM id=form1 name=form1 action="${pageContext.request.contextPath }/customer_add.action" method="post" enctype="multipart/form-data">
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>信息来源 ：</td>
								<td>
									<select name="level.dict_id" id="sourceId"></select>
								</td>
								<td>联系人：</td>
								<td>
