...
<BODY>
<FORM id=form1 name=form1 action="${ pageContext.request.contextPath }/user_regist.action" onsubmit="return checkForm()"
      method=post>
                                    ...
                                    <TABLE cellSpacing=0 cellPadding=2 border=0>
                                        ...
                                        <TR>
                                            ...
                                            <TD style="HEIGHT: 28px">
                                                <INPUT id="user_password" style="WIDTH: 130px" type=password
